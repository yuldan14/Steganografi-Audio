...
num_lsb = 11
bytes_to_recover= 101

#Colours
Home_BACK_COL = "#000080"
ButtonColour_1 = "#00FF00"
ButtonColour_2 = "#f39797"
ButtonColour_3 = "#E66A82"
Banner_Colour_1 = "#00FFFF"
Banner_Colour_2 = "#00FFFF"
...
def show_EncodeScreen():
    ...
    Label(encode_banner_Frame,text=" ",font=("arial",1,ITALIC),bg=Banner_Colour_1).pack()
    Encode_Banner = Label(encode_banner_Frame,text=" ENCODE FILE",font=("arial",25,ITALIC),bg=Banner_Colour_1)
    Encode_Banner.pack()
    Label(encode_banner_Frame,text=" ",font=("arial",2),bg=Banner_Colour_1).pack()
    encode_Description = Label(encode_banner_Frame,text="Panduan Encode:\n1. Pilih Audio\n2. Klik Carrier audio berformat .wav \n3. Pilih Lokasi Output untuk hasil encodenya\n4. Pilih metode pengisian teks \n5. Klik Encode untuk memulai",font=("arial",11,ITALIC),bg=Banner_Colour_1)
    encode_Description.pack()
    encode_banner_Frame.pack()

    Label(EncodeFrame,text=" ",font=("arial",8),bg=Home_BACK_COL).pack()
    Text_button = Label(EncodeFrame,text="Klik Audio di Bawah",font=("Lucida Bright",14,BOLD,ITALIC),bg=Home_BACK_COL)
    Text_button.pack()
    ...
    Label(EncodeFrame,text=" ",font=("arial",4),bg=Home_BACK_COL).pack()
    Image_button = Label(EncodeFrame,text="",font=("Lucida Bright",14,BOLD,ITALIC),bg=Home_BACK_COL)
    Image_button.pack()
...
def show_DecodeScreen():
    ...
    Decode_Banner = Label(Decode_banner_Frame,text=" DECODE ",font=("arial",35,),bg=Banner_Colour_1)
    Decode_Banner.pack()
    Label(Decode_banner_Frame,text=" ",font=("arial",2),bg=Banner_Colour_1).pack()
    Decode_Description = Label(Decode_banner_Frame,text="Panduan Decode Audio:\n1. Pilih Audio \n2. Cari audio yang sudah diencode \n3. Pilih lokasi folder untuk outputnya \n4. Klik Decode \n5. Klik Open Text Editor untuk melihat pesannya",font=("arial",11),bg=Banner_Colour_1)
    Decode_Description.pack()
    Decode_banner_Frame.pack()

    Label(DecodeFrame,text=" ",font=("arial",8),bg=Home_BACK_COL).pack()
    Text_button = Label(DecodeFrame,text="Klik Audio di Bawah",font=("Lucida Bright",14,BOLD,ITALIC),bg=Home_BACK_COL)
    Text_button.pack()
    ...
    Label(DecodeFrame,text=" ",font=("arial",4),bg=Home_BACK_COL).pack()
    Image_button = Label(DecodeFrame,text="",font=("Lucida Bright",14,BOLD,ITALIC),bg=Home_BACK_COL)
    Image_button.pack()
...
def show_HomeScreen():
    ...
    home_banner_Frame = Frame(mainWindow,bd=80,relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2)

    Label(mainWindow,text=" ",font=("arial",2),bg=Home_BACK_COL).pack()

    Label(home_banner_Frame,text=" ",font=("arial",1,ITALIC),bg=Banner_Colour_1).pack()
    Home_Banner = Label(home_banner_Frame,text=" STEGANOGRAFI ",font=("elephant",15),bg=Banner_Colour_1)
    Home_Banner.pack()
    Label(home_banner_Frame,text=" ",font=("arial",2),bg=Banner_Colour_1).pack()
    Home_Description = Label(home_banner_Frame,text="Dibuat oleh:\nMuhamad Faiq Yusuf Raharja 227006127 \nYuldan Nur Addinsyah 227006091 \nAgus Budi Hartono 227006121",font=("arial",13,ITALIC),bg=Banner_Colour_1)
